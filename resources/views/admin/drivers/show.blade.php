            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-3 text-center mb-3">
                        ...
                        <img src="{{ Storage::disk('spaces')->url($driver->profile_picture) }}"
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="text-center">
                            ...
                            <a href="{{ Storage::disk('spaces')->url($driver->driverDocuments->driver_license_file) }}"
                    ...
                    <div class="col-md-4">
                        <div class="text-center">
                            ...
                            <a href="{{ Storage::disk('spaces')->url($driver->driverDocuments->vehicle_registration_file) }}"
                    ...
                    <div class="col-md-4">
                        <div class="text-center">
                            ...
                            <a href="{{ Storage::disk('spaces')->url($driver->driverDocuments->insurance_certificate_file) }}"
